...
* Customize and create a new dashboard widget. (For details, see see :ref:`Creating a Widget <create_widget>` and :ref:`Adding Widgets to a Dashboard <user_dashboards>`.)

If you contributed the sensor to the WoTKit, you can also:

* Delete the sensor by clicking the *Delete* button.
* Edit sensor information by clicking the *Edit Sensor* button. (For details,
  see :ref:`Editing Sensors <edit_sensor>`.)
